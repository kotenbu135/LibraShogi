...
### 0.2 いま鳴っていないか（2026-09-21、320 万局）

**鳴っていない。下に外れている点は 1 つも無い。**

| 節目 | 目盛り | 目安の線 | ずれ | 判定 |
|---|---|---|---|---|
| 200 万局 | +1,138.6 | +1,151.3 | −12.7 | 95% 区間が線にかかる |
| 240 万局 | +1,177.2 | +1,200.7 | −23.5 | 同 |
| 280 万局 | +1,206.0 | +1,236.8 | −30.8 | 同 |
| 320 万局 | +1,233.5 | +1,265.5 | −32.0 | 同 |

**2026-09-20 に「1 点目」と数えかけた 280 万局の点（当時 −37.5）は、データが増えて条件から外れた。**
節目が 1 つ増えて目盛りが引き直され、その点の対局数も 2,400 → 4,400 に増えて幅が変わったため。
...
### 0.3 見ておく数字（2026-09-21）

**最強比を「局数 2 倍あたり」に直すと、320 万局がこれまでで一番低い。**
...
幅が広く前の 3 つと重なるので、**1 点では鈍ったと言えない**。目盛り全体の傾きも +186 のまま。
**直接対局の鎖（160 万 → 320 万局で +218 / 2 倍）とまとめた目盛り（160 万局以降 +152 / 2 倍）の
食い違いも続いている**（χ²/df 29.2）。この食い違いは、新しい参照で測る 360 万局の点で決着する。
